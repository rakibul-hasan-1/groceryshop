					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="">
									<a class="nav-stylehead" href="{{route('faq')}}">Faqs</a>
								</li>
								<li class="dropdown">
		...
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<a href="{{route('product')}}">Grocery</a>
							</li>
							<li>
								<a href="{{route('product')}}">Fruits</a>
							</li>
							<li>
								<a href="{{route('product')}}">Soft Drinks</a>
							</li>
							<li>
								<a href="{{route('product2')}}">Dishwashers</a>
							</li>
							<li>
								<a href="{{route('product')}}">Biscuits & Cookies</a>
							</li>
							<li>
								<a href="{{route('product2')}}">Baby Diapers</a>
							</li>
						</ul>
					</div>
					<div class="col-xs-6 footer-grids agile-secomk">
						<ul>
							<li>
								<a href="{{route('product')}}">Snacks & Beverages</a>
							</li>
							<li>
								<a href="{{route('product')}}">Bread & Bakery</a>
							</li>
							<li>
								<a href="{{route('product')}}">Sweets</a>
							</li>
							<li>
								<a href="{{route('product')}}">Chocolates & Biscuits</a>
							</li>
							<li>
								<a href="{{route('product2')}}">Personal Care</a>
							</li>
							<li>
								<a href="{{route('product')}}">Dried Fruits & Nuts</a>
							</li>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some">
					...
					<ul>
						<li>
							<a href="{{route('product')}}">Aashirvaad</a>
						</li>
						<li>
							<a href="{{route('product')}}">Amul</a>
						</li>
						<li>
							<a href="{{route('product')}}">Bingo</a>
						</li>
						<li>
							<a href="{{route('product')}}">Boost</a>
						</li>
						<li>
							<a href="{{route('product')}}">Durex</a>
						</li>
						<li>
							<a href="{{route('product')}}"> Maggi</a>
						</li>
						<li>
							<a href="{{route('product')}}">Glucon-D</a>
						</li>
						<li>
							<a href="{{route('product')}}">Horlicks</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Head & Shoulders</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Dove</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Dettol</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Dabur</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Colgate</a>
						</li>
						<li>
							<a href="{{route('product')}}">Coca-Cola</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Closeup</a>
						</li>
						<li>
							<a href="{{route('product2')}}"> Cinthol</a>
						</li>
						<li>
							<a href="{{route('product')}}">Cadbury</a>
						</li>
						<li>
							<a href="{{route('product')}}">Bru</a>
						</li>
						<li>
							<a href="{{route('product')}}">Bournvita</a>
						</li>
						<li>
							<a href="{{route('product')}}">Tang</a>
						</li>
						<li>
							<a href="{{route('product')}}">Pears</a>
						</li>
						<li>
							<a href="{{route('product')}}">Oreo</a>
						</li>
						<li>
							<a href="{{route('product')}}"> Taj Mahal</a>
						</li>
						<li>
							<a href="{{route('product')}}">Sprite</a>
						</li>
						<li>
							<a href="{{route('product')}}">Thums Up</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Fair & Lovely</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Lakme</a>
						</li>
						<li>
							<a href="{{route('product')}}">Tata</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Sunfeast</a>
						</li>
						<li>
							<a href="{{route('product2')}}">Sunsilk</a>
						</li>
						<li>
							<a href="{{route('product')}}">Patanjali</a>
						</li>
						<li>
							<a href="{{route('product')}}">MTR</a>
						</li>
						<li>
							<a href="{{route('product')}}">Kissan</a>
						</li>
						<li>
							<a href="{{route('product2')}}"> Lipton</a>
						</li>
					</ul>
				</div>
				<!-- //brands -->

					...
					<div class="product-sec1">
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('assets/images/k1.jpg')}}" alt="">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Zeeba Basmati Rice</a>
									</h4>
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Maiyas Gulab Jamun</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Lipton Green Tea</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Organicana Red Chilli</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">MTR Black Pepper</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Chataka - Elaichi</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Narulag, Less Sugar</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Kellogg's Chocos Fills</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Amul's India</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Snickers Chocolates</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">Kissan Fruit Jam</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{route('single')}}">MTR Vegetable Pickle</a>
									</h4>
									<div class="info-product-price">
